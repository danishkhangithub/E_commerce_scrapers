...
import time
import socket
from cuncurrent.features import ThreadPoolExecutor
...
#                        proxies.append(proxy)
            ...
            except Exception as a: return e

#        # return random proxy if found, try again otherwise
#        if len(proxies): return proxies#random.choice(proxies)
