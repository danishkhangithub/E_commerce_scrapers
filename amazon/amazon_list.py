...
class Amazonspider(scrapy.Spider):
    ...
    def parse_listing(self, response):
        print('\nPAGE NO\t',response.meta.get('page'))
    ...
    def parse_products(self, response):
        #print('\nPRODUCT COUNT\t', response.meta.get('product_count'),'\n')
...
#        print(url2.split('dp/')[1].split('/ref')[0])
        ...
        try:
          Produts_benefits = response.css('#productOverview_feature_div .a-truncate-cut::text').get()
        except:
        ...
        try:
          Price = response.css('#corePrice_desktop span span::text').get()
        except Exception as e:
          print('\tPrice',e)
          Price = 'N/A'
        ...
        try:
          ...
          Reviews = 'N/A'
        try:
          Ratings = response.css('.a-star-4-5 span::text').get()
        except Exception as e:
          print('\tRatings',e)
          Ratings = 'N/A'
        ...
        print('\nTOTAL PRODUCTS\t',self.product_count,'\n')
